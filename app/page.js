    ...
    <div className="min-h-screen">
      ...
      <section className="bg-green-50 py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">The ultimate peer-to-peer electricity marketplace. <br/> Buy, sell, and trade energy seamlessly..</p>
      ...
      <section className="bg-green-800 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <a href="/register" className="bg-white text-green-800 px-8 py-3 rounded-lg hover:bg-gray-100 transition-colors">Join Today</a>
        </div>
      </section>
    </div>
  );
